...
namespace ProperDeedRealty.Data.Helpers
{
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// </summary>
        public TheCoreBankingRetailContext DbContext { get; set; }
        ...
        /// </remarks>
        public virtual T GetRepository<T>(Func<TheCoreBankingRetailContext, object> factory = null) where T : class
        {
